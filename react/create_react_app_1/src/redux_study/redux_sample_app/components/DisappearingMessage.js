 ...
 * Div containing message is rendered for first time with certain html class and after speficified time elapses
 ...
 * properties the transition won't happen asuseEffect hook in <DisappearingMessage/> would already had been ran before when
